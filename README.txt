...
3. Importer le fichier prenoms.sql dans votre BDD

4. Ouvrir le fichier index.php avec un navigateur

5. Exo 1 nommé import.php (terminé)

6. Exo 2 nommé recherche.php (terminé à 90%)

7. Exo 2 nommé traitement.php (non fonctionnel)
